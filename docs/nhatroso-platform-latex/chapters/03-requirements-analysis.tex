...
Trong quản lý dự án phần mềm, việc xác định các bên liên quan (Stakeholders) là bước quan trọng để hiểu rõ kỳ vọng và xây dựng chiến lược phù hợp. Dự án Nhatroso ứng dụng Ma trận Quyền hạn - Mối quan tâm\footnote{Một khung quản trị được sử dụng để phân loại các bên liên quan dựa trên mức độ ảnh hưởng và mức độ quan tâm của họ đối với dự án.} \cite{Mendelow1981} để phân loại các nhóm stakeholder cốt lõi.
...
\subsection{Quản lý dịch vụ và bảng giá}
