...
\textbf{Kiểm thử ràng buộc cơ sở dữ liệu:} Sử dụng Loco testing infrastructure để chạy các integration tests trên database thực (SQLite/PostgreSQL). Xác minh các ràng buộc \texttt{unique} trên mã phòng, sự chồng chéo của \texttt{price\_rules} và tính duy nhất của hóa đơn theo kỳ.
