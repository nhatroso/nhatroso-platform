...
export async function getAutoInvoiceConfig(): Promise<AutoInvoiceConfig | null> {
  const response = await apiFetch('/auto-invoice-configs');
...
export async function updateAutoInvoiceConfig(
