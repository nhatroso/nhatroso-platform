...
│  • Create docs/features/{feature-name}/{TASK-SLUG}-PLAN.md (MANDATORY) │
└─────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────┐
│              CHECKPOINT: PLAN VERIFICATION                   │
│  🔴 VERIFY: Does docs/features/{feature-name}/{TASK-SLUG}-PLAN.md exist? │
...
| 1.5   | **PLAN VERIFICATION**           | ❌        | PLAN.md exists      | ✅ **File exists in docs/features/** |
