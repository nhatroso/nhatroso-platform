...
| Step | Agent                       | Action                                                  |
| ---- | --------------------------- | ------------------------------------------------------- |
| 1    | `project-planner`           | Create docs/features/{feature-name}/{TASK-SLUG}-PLAN.md |
...
```
After FEATURE-NAME-PLAN.md is complete, ASK:

"✅ Plan created: docs/features/{feature-name}/{TASK-SLUG}-PLAN.md
...
| ----------------------- | --------- | ---------------------------------------------------------------- |
| `project-planner`       | Planning  | Task breakdown, docs/features/{feature-name}/{TASK-SLUG}-PLAN.md |
...
| ---------------------------------------------------------------------- | -------------------------------- |
| NO `docs/features/{feature-name}/{TASK-SLUG}-PLAN.md`                  | → Go to PHASE 1 (planning only)  |
| YES `docs/features/{feature-name}/{TASK-SLUG}-PLAN.md` + user approved | → Go to PHASE 2 (implementation) |
...
```
Use the project-planner agent to create docs/features/{feature-name}/{TASK-SLUG}-PLAN.md
